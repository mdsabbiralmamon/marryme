...
document.getElementById('buttons-container').addEventListener('click', function (event) {
    ...
    if (event.target.id === 'noClicked') {
        ...
        const audio = new Audio("https://raw.githubusercontent.com/mdsabbiralmamon/marryme/main/src/audio/ahaha.mp3");
        audio.loop = true;
        audio.play();
    }
});
...
function playAudio() {
    const audio = new Audio("https://raw.githubusercontent.com/mdsabbiralmamon/marryme/main/src/audio/mouseClick.mp3");
    audio.play();
}